    ...
    <section class="login-form">
      <div class="login-inner">
        ...
        <form @submit.prevent="login">
          <label>用户名<input v-model="username" placeholder="例如：S001" /></label>
          <label>密码<input v-model="password" type="password" placeholder="与编号相同" /></label>
        ...
        <p class="hint">演示账号（用户名=密码=编号）：<br>学生 S001 · 教授 P001 · 教务 R001</p>
      </div>
    </section>
  </div>
</template>
